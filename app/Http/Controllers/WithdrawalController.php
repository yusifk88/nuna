...
class WithdrawalController extends Controller
{
    ...
    public function sendToBank($wedding_id, Request $request)
    {
        ...
        if ($res && $res['code'] == '000') {
            ...
            return failed_response(["errors" =>['bank_error'=> ["This service is currently unavailable, please contact support"]]], Response::HTTP_UNPROCESSABLE_ENTITY, 'This service is currently unavailable, please contact support');
        }
