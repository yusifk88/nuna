...
<head>
    ...
    <script type="text/javascript">
        ...
        (function () {
            ...
            s1.async = true;
            s1.src = 'https://embed.tawk.to/63bf3892c2f1ac1e202cf879/1gmhf9vi0';
            s1.charset = 'UTF-8';
                        ...
                        <div class="single-footer-caption mb-30">
                            ...
                            <div class="footer-logo text-center">
                                ...
                                <ul class="fh5co-social-icons">
                                    ...
                                    <li><a href="https://twitter.com/mynunahq?s=20"><i class="icon-twitter"></i></a>
                                    </li>
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle text-center">
                                ...
                                <strong class="mt-4">Email:</strong> <br><span
                                    class="text-muted">hello@mynunaa.com</span><br>
                                <strong class="mt-4">Tel:</strong> <br><span class="text-muted">0592489135</span><br>
